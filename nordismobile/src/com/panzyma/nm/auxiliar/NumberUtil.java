...
public abstract class NumberUtil {
    ...
    /**
     * Retorna el digito numerico con formato de acuerdo al registrado en el parametro del sistema
     * 
     * @param numero
     *            digito a a dar formáto
     * @param position
     *            cnt es el contexto del cual se hace el llamado
     * @return Digito con formato
     */
    public static String getFormatoNumero(int numero, Context cnt) 
    {
    ...
    public static String setFormatPrefijo(Integer prefijo,long number)
    {
    	String num1=String.valueOf(prefijo);
