...
public final class CCNotaDebito implements KvmSerializable, GenericDocument,
	...
	public CCNotaDebito(Parcel parcel) {
	...
	public Object getProperty(int _index) {
		...
		case 5:
			return new Integer(Dias);
		case 6:
			return Concepto;
		case 7:
			return new Float(Monto);
		case 8:
			return new Float(MontoAbonado);
		case 9:
	...
	public void setProperty(int _index, Object _obj) {
		...
		case 4:
			...
			break;
		case 5:
			Dias = Integer.parseInt(_obj.toString());
			break;
		case 6:
		...
		case 7:
			...
			break;
		case 8:
			MontoAbonado = Float.parseFloat(_obj.toString());
			break;
		case 9:
			Saldo = Float.parseFloat(_obj.toString());
			break;
		case 10:
	...
	public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
		...
		@Override
		public CCNotaDebito createFromParcel(Parcel parcel) {
			return new CCNotaDebito(parcel);
		}

		@Override
		public CCNotaDebito[] newArray(int size) {
			return new CCNotaDebito[size];
		}
	...
	public void writeToParcel(Parcel parcel, int flags) {
		...
		parcel.writeFloat(MontoAbonado);
