...
public final class CCNotaCredito implements KvmSerializable, GenericDocument,
		Parcelable {
	...
	public CCNotaCredito(Parcel parcel) {
	...
	private void readFromParcel(Parcel parcel) {
		...
		FechaVence = parcel.readLong();
		Concepto = parcel.readString();
		Monto = parcel.readFloat();
		NumRColAplic = parcel.readString();
		CodEstado = parcel.readString();
		Descripcion = parcel.readString();
		Referencia = parcel.readInt();
		CodConcepto = parcel.readString();
	}
	...
	public Object getProperty(int _index) {
		...
		case 2:
			return Numero;
		case 3:
			return new Long(Fecha);
		case 4:
			return new Long(FechaVence);
		case 5:
			return Concepto;
		case 6:
	...
	public void setProperty(int _index, Object _obj) {
		switch (_index) {
		case 0:
			NombreSucursal = (java.lang.String) _obj;
			break;
		case 1:
			Estado = (java.lang.String) _obj;
			break;
		case 2:
			Numero = (java.lang.String) _obj;
			break;
		case 3:
			Fecha = Long.parseLong(_obj.toString());
			break;
		case 4:
			FechaVence = Long.parseLong(_obj.toString());
			break;
		case 5:
			Concepto = (java.lang.String) _obj;
			break;
		case 6:
			Monto = Float.parseFloat(_obj.toString());
			break;
		case 7:
			NumRColAplic = (java.lang.String) _obj;
			break;
		case 8:
			CodEstado = (java.lang.String) _obj;
			break;
		case 9:
			Id = Long.parseLong(_obj.toString());
			break;
		case 10:
			Descripcion = (java.lang.String) _obj;
			break;
		case 11:
			Referencia = Integer.parseInt(_obj.toString());
			break;
		case 12:
			CodConcepto = (java.lang.String) _obj;
			break;
		}
	}
	...
	public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
		...
		@Override
		public CCNotaCredito createFromParcel(Parcel parcel) {
			return new CCNotaCredito(parcel);
		}

		@Override
		public CCNotaCredito[] newArray(int size) {
			return new CCNotaCredito[size];
		}
	...
	public void writeToParcel(Parcel parcel, int flags) {
		...
		parcel.writeString(NumRColAplic);
