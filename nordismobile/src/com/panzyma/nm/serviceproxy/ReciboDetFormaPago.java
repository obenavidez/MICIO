...
public class ReciboDetFormaPago implements KvmSerializable,Parcelable {
    ...
    public ReciboDetFormaPago(long id, long objFormaPagoID, java.lang.String codFormaPago, java.lang.String descFormaPago, java.lang.String numero, long objMonedaID, java.lang.String codMoneda, java.lang.String descMoneda, float monto, float montoNacional, long objEntidadID, java.lang.String codEntidad, java.lang.String descEntidad, int fecha, java.lang.String serieBilletes, float tasaCambio) {
        this.Id = id;
	...
	public Object getProperty(int _index) {
        ...
        {        
        	...
        	case 1: return new Long(ObjFormaPagoID);
        	case 2: return CodFormaPago;
        	case 3: return DescFormaPago;
        	case 4: return Numero;
        	case 5: return new Long(ObjMonedaID);
        	case 6: return CodMoneda;
        	case 7: return DescMoneda;
        	case 8: return Monto;
        	case 9: return MontoNacional; 
        	case 10: return new Long(ObjEntidadID);
        	case 11: return CodEntidad; 
        	case 12: return DescEntidad; 
        	case 13: return new Integer(Fecha);
        	case 14: return SerieBilletes;
        	case 15: return TasaCambio;       
        } 
		return null;
	}
	...
	public void setProperty(int _index, Object _obj) {
        switch(_index)  
        {
	        ...
	        case 1:  ObjFormaPagoID = Long.parseLong(_obj.toString()); break;
	        case 2:  CodFormaPago =  (_obj.toString()); break;
	        case 3:  DescFormaPago =  (_obj.toString()); break;
	        case 4:  Numero =  (_obj.toString()); break;
	        case 5:  ObjMonedaID = Long.parseLong(_obj.toString()); break;
	        case 6:  CodMoneda =  (_obj.toString()); break;
	        case 7:  DescMoneda =  (_obj.toString()); break;
	        case 8:  Monto = Float.valueOf(_obj.toString()); break;
	        case 9:  MontoNacional = Float.valueOf(_obj.toString()); break;
	        case 10: ObjEntidadID = Long.parseLong(_obj.toString()); break;
	        case 11:  CodEntidad =  (_obj.toString()); break;
	        case 12:  DescEntidad =  (_obj.toString()); break;
	        case 13:  Fecha = Integer.valueOf(_obj.toString()); break;
	        case 14:  SerieBilletes =  (_obj.toString()); break;
	        case 15:  TasaCambio = Float.valueOf(_obj.toString()); break;
        }
