...
public class Ventas 
{
    ...
    */
    public static float getPrecioPromedioProducto(Producto prod, long idTipoPrecio) {
        Vector precios = parseListaPrecios(prod, idTipoPrecio);
        if (precios.size() == 0) return 0F;
    ...
    public static Vector parseListaBonificaciones(Producto prod, long idCatCliente) {
    ...
    */
    ...
    public static String getNumeroPedido(int numero,Context cnt) {        
        int cr = Integer.parseInt(cnt.getSharedPreferences("SystemParams",android.content.Context.MODE_PRIVATE).getString("CerosRellenoNumRefPedido", "0"));
