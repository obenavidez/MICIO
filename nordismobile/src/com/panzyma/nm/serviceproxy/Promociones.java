		...
		if (cur.moveToFirst()) 
		{
			do {
				...
				aprom.add(new com.panzyma.nm.serviceproxy.Promocion(
						...
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.AplicaCredito))), 
						...
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.AplicacionMultiple))), 
						Integer.parseInt(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.CantidadMinimaItems))), 
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.CantidadMinimaBaseUnica))), 
						Integer.parseInt(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.CantidadMinimaBase))), 
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.CantidadPremioUnica))), 
						...
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.MontoBaseUnico))),					
						...
						Boolean.parseBoolean(cur.getString(cur.getColumnIndex(com.panzyma.nm.auxiliar.NMConfig.Promocion.MontoPremioUnico))),
