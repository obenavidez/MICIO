...
public  class DetallePedido implements KvmSerializable,Parcelable{
	...
	public Object getProperty(int _index) {
        ...
        case 10: return Precio;
        case 11: return MontoPrecioEditado;
        case 12: return new Boolean(PrecioEditado);
        case 13: return Subtotal;
        case 14: return Descuento;
        case 15: return PorcImpuesto;
        case 16: return Impuesto;
