...
public class GenericAdapter2<E, V> extends BaseAdapter implements Filterable {
	...
	public GenericAdapter2(Context c,Class<V> viewclass,List<E> items,int... layoutid) { 		 
		this.context=c;
